...
// for (var i = 0; i < s.length; i++) {
//   if (s[i].toUpperCase() == s[i]) {
//     arregloMayus.push(s[i]);
//   } else {
//     arregloMinus.push(s[i]);
//   }
// }
// for (var i = 0; i < arregloMayus.length; i++) {
//   nuevoString = nuevoString + arregloMayus[i];
// }
// for (var i = 0; i < arregloMinus.length; i++) {
//   nuevoString = nuevoString + arregloMinus[i];
// }
// return nuevoString;
//}
